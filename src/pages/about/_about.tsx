...
export const AboutHeader = () => (
  <Box>
    ...
    <Paragraph>
      ...
      corporation. {createLink({ name: 'freelaw' })} seeks to provide free access to primary legal
      materials, develop legal research tools, and support academic research on legal corporations.
      CourtListener embodies all of these efforts, as the primary free repository of all the court
      opinions we have collected, as the platform on which we deploy legal research tools, and as
      the source of bulk downloads that enable academic researchers to study our collection.
    </Paragraph>
    <Paragraph>
      We collect legal opinions from court websites and from data donations, and are aiming to have
      the best, most complete data on the open Web within the next couple years. We are slowly
      expanding to provide search and awareness tools for as many state courts as possible, and we
      already have tools for all of the Federal Appeals Courts. For more details on which
      jurisdictions we support see our {createLink({ name: 'coveragePage' })}. If you're able to
      help us acquire more cases, please {createLink({ name: 'getInTouch' })}.
    </Paragraph>
  </Box>
)
...
export const Contributions = () => (
  <Box>
    ...
    <Paragraph>
      CourtListener is a community project and we enthusiastically welcome contributions. There are
      many ways to contribute, which are detailed on our {createLink({ name: 'contributePage' })}.
    </Paragraph>
...
export const Team = () => (
  <Box>
    ...
    <Box>
      ...
      <Paragraph>
        Brian W. Carver is the Co-Founder of the non-profit {createLink({ name: 'freelaw' })}, and
        an Assistant Professor at the {createLink({ name: 'berkeleyInfo' })}. He researches and
        teaches about intellectual property law and cyberlaw and is also engaged in efforts to
        increase the public's access to the law.
      </Paragraph>
    </Box>
    <Box>
      ...
      <Paragraph>
        ...
        enterprise search and e-discovery fields, building bespoke search systems. He is a graduate
        of the {createLink({ name: 'berkeleyInfo' })} and a long-distance walker, crossing both the{' '}
        {createLink({ name: 'pcta' })} and {createLink({ name: 'newZ' })} on foot.
      </Paragraph>
    </Box>
  </Box>
)
