...
const Donate = () => (
  <Box>
    ...
    <Paragraph>
      Support our efforts to make high quality legal data widely available.
      Help us reform and enhance the legal ecosystem.
    </Paragraph>
    <Paragraph>
    ...
    <Text size="xxsmall">
      ...
      Free Law Project's various initiatives as determined by the board of directors.
      Please {<Anchor href="/contact" label="get in touch"/>} if you wish to make a
      restricted donation for a particular purpose.
    </Text>
  </Box>
)
