...
const SelectInput = (props: { name: string; label: string; options: string[] }) => (
  <Box>
    <Heading level={5}>{props.label}</Heading>
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <Box direction="column" align="center">
        ...
        {values.donationMethod === 'CreditCard' && (
          <Heading level={5}>CreditCard Form Placeholder</Heading>
        )}
        ...
        {(values.donationMethod === 'CreditCard' || values.donationMethod === 'PayPal') && (
          <>
            ...
            <Button
              ...
              type="submit"
              label="Donate to Free Law Project"
            />
          </>
        )}
        {values.donationMethod === 'Check' && (
          <>
            <Paragraph>
              ...
              {<Anchor href="/contact" label="get in touch" />} on our contact page. Unfortunately,
              due to the nature of our work, we no longer have a public mailing address.
            </Paragraph>
            <Paragraph>
              We cannot accept starter checks, unnumbered checks or non-personalized checks.
            </Paragraph>
            <Paragraph>Thank you for your donation.</Paragraph>
          </>
        )}
        {values.donationMethod === 'Cryptocurrency' && (
          <>
            ...
            <Anchor
              href="bitcoin:19FBmVguf86kaxEM7air6EDrtq5bJSo8qs"
              label="19FBmVguf86kaxEM7air6EDrtq5bJSo8qs"
            />

            <Paragraph>
              To donate to Free Law Project using Bitcoin Cash, please use the address or QR code
              below.
            </Paragraph>
            ...
            <Paragraph>
              To donate to Free Law Project using Stellar Lumens, please use the following address
              and memo:
